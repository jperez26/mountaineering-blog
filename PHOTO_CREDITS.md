...
Mountain photos are sourced from Wikimedia Commons under their original licenses, which require attribution. Keep this file if you keep these photos; if you replace a photo with your own, delete its row.
...
| File | Subject | Photographer | License | Source |
|---|---|---|---|---|
| `public/images/eight-thousanders/everest.jpg` | Mount Everest | Rdevany | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Mt._Everest_from_Gokyo_Ri_November_5,_2012.jpg) |
| `public/images/eight-thousanders/k2.jpg` | K2 | Zacharie Grossen | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chogori.jpg) |
| `public/images/eight-thousanders/lhotse.jpg` | Lhotse | Uwe Gille | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lhotse-fromChukhungRi.jpg) |
| `public/images/eight-thousanders/makalu.jpg` | Makalu | Ben Tubby | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Makalu.jpg) |
| `public/images/eight-thousanders/cho-oyu.jpg` | Cho Oyu | Robstar06 (German Wikipedia) | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chooyu.jpg) |
| `public/images/eight-thousanders/dhaulagiri.jpg` | Dhaulagiri | Sergey Ashmarin | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Dhaulagiri_-_view_from_aircraft.jpg) |
...
(Kangchenjunga reuses `public/images/climbs/kangchenjunga.jpg`, credited above.)

## Gear photos

Gear item photos are official manufacturer product images, used here for editorial review purposes. Unlike the mountain photos above, these are **not** freely licensed — the manufacturer retains copyright. If this site is ever meant to be public/commercial rather than a personal log, replace these with your own photos of your own gear, or confirm usage rights with the manufacturer first.

| File | Product | Source |
|---|---|---|
| `public/images/gear/petzl-sirocco.jpg` | Petzl Sirocco | Petzl official product page (petzl.com) |

La Sportiva and Black Diamond block automated fetches (403/blocked) from their own sites, and retailer product-page URLs I tried didn't resolve to a real listing. Those two still use the illustrated placeholder (`/images/placeholders/gear-neutral.svg`) rather than risk grabbing an unverified or mismatched image. Easiest fix: snap a quick photo of your own boots/tent and drop it into `public/images/gear/` per CONTENT_GUIDE.md — that also makes the review more genuinely yours.
